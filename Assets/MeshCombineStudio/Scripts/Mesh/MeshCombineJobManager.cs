...
namespace MeshCombineStudio
{
    ...
    public class MeshCombineJobManager : MonoBehaviour
    {
        ...
        public void AddJob(MeshCombiner meshCombiner, MeshObjectsHolder meshObjectsHolder, Transform parent, Vector3 position)
        {
            ...
            if (meshObjects.Count < 2 && !meshCombiner.removeTrianglesBelowSurface && !meshCombiner.removeOverlappingTriangles && !meshCombiner.removeBackFaceTriangles)
            {
                ...
                else if (meshObjects.Count == 1)
                {
                    ...
                    cachedComponents.mr.sharedMaterials = meshObject.cachedGO.mr.sharedMaterials;
                }
